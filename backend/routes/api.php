...
//            Route::put('/{id}/payment-method', [SubscriptionController::class, "updatePaymentMethod"])->name('subscription.updatePaymentMethod');
    ...
    Route::prefix('series/{seriesId}')->group(function () {
        ...
        Route::put('/seasons/{seasonId}', [SeasonController::class, "update"])->name('seasons.update');
        Route::delete('/seasons/{seasonId}', [SeasonController::class, "destroy"])->name('seasons.destroy');

        // Episodes routes
        Route::get('/seasons/{seasonId}/episodes', [EpisodeController::class, "index"])->name('episodes.index');
        Route::post('/seasons/{seasonId}/episodes', [EpisodeController::class, "store"])->name('episodes.store');
        Route::get('/seasons/{seasonId}/episodes/{episodeId}', [EpisodeController::class, "show"])->name('episodes.show');
        Route::put('/seasons/{seasonId}/episodes/{episodeId}', [EpisodeController::class, "update"])->name('episodes.update');
        Route::delete('/seasons/{seasonId}/episodes/{episodeId}', [EpisodeController::class, "destroy"])->name('episodes.destroy');

        // Subtitles routes
        Route::get('/seasons/{seasonId}/episodes/{episodeId}/subtitles', [SubtitleController::class, "index"])->name('episodes.subtitles.index');
        Route::post('/seasons/{seasonId}/episodes/{episodeId}/subtitles', [SubtitleController::class, "store"])->name('episodes.subtitles.store');
        Route::put('/seasons/{seasonId}/episodes/{episodeId}/subtitles', [SubtitleController::class, "update"])->name('episodes.subtitles.update');
        Route::delete('/seasons/{seasonId}/episodes/{episodeId}/subtitles', [SubtitleController::class, "destroy"])->name('episodes.subtitles.destroy');
    });
